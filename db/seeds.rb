...
#   Mayor.create(name: 'Emanuel', city: cities.first)
   ...
   Achievements.create(name:"Create App 1", value:500)
   Achievements.create(name:"Create App 2", value:500)
   Achievements.create(name:"Give Presentation", value:500)
   Achievements.create(name:"Midterm Test", value:1000)
   Achievements.create(name:"Final Exam", value:1000)
   Achievements.create(name:"Final Project", value:1000)
